...
function navigateTo(page) {
    ...
    // If the original page token is like "model-detail.html", route it to pages/<slug>/index.html.
    const isSimpleHtml = /^[^\/]+\.html$/i.test(page);
    if (!isSimpleHtml) {
    ...
    const target = inPagesDir ? `../${slug}/index.html` : `pages/${slug}/index.html`;
